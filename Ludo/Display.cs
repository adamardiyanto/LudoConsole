...
static public class Display
{
    ...
    {  //    '1' '2' '3' '4' '5' '6' '7' '8' '9' "[ ]" '1' '2' '3' '4' '5'  
        ...
        {" | "," + "," + "," + "," + "," + "," + ","[ ]","\u001b[34m[ ]\u001b[0m","[ ]"," + "," + "," + "," + "," + "," + "," | "}, // 6
        {" | ","[ ]","[S]","[ ]","[ ]","[ ]","[ ]","---","---","---","[ ]","[ ]","[ ]","[*]","[ ]","[ ]"," | "}, // 7
        {" | ","[ ]","\u001b[32m[ ]\u001b[0m","\u001b[32m[ ]\u001b[0m","\u001b[32m[ ]\u001b[0m","\u001b[32m[ ]\u001b[0m","\u001b[32m[ ]\u001b[0m","---","---","---","\u001b[33m[ ]\u001b[0m","\u001b[33m[ ]\u001b[0m","\u001b[33m[ ]\u001b[0m","\u001b[33m[ ]\u001b[0m","\u001b[33m[ ]\u001b[0m","[ ]"," | "}, // 8
        {" | ","[ ]","[ ]","[*]","[ ]","[ ]","[ ]","---","---","---","[ ]","[ ]","[ ]","[ ]","[S]","[ ]"," | "}, // 9
        {" | "," + "," + "," + "," + "," + "," + ","[ ]","\u001b[31m[ ]\u001b[0m","[ ]"," + "," + "," + "," + "," + "," + "," | "}, // 10    
        {" | "," + ","---","---","---","---"," + ","[ ]","\u001b[31m[ ]\u001b[0m","[ ]"," + ","---","---","---","---"," + "," | "}, // 11
        {" | "," + ","---","[ ]","[ ]","---"," + ","[ ]","\u001b[31m[ ]\u001b[0m","[ ]"," + ","---","[ ]","[ ]","---"," + "," | "}, // 12
    ...
    {
        if (color == Color.Blue) return "\u001b[34m[B]\u001b[0m";
        else if (color == Color.Yellow) return "\u001b[33m[Y]\u001b[0m";
        else if (color == Color.Red) return "\u001b[31m[R]\u001b[0m";
        else return "\u001b[32m[G]\u001b[0m"; //green
    }
}